...
class ShiftHours(LiveServerTestCase):
    ...
    def test_view_with_logged_shift(self):
        ...
        self.assertEqual(completed_shifts_page.get_shift_date(),
                         'June 15, 2017')
        ...
        self.assertEqual(completed_shifts_page.get_edit_shift_hours(),
                         'Edit Hours')
        self.assertEqual(completed_shifts_page.get_clear_shift_hours(),
                         'Clear Hours')
    ...
    def test_edit_hours(self):
        ...
        self.assertEqual(completed_shifts_page.get_shift_start_time(),
                         '10 a.m.')
        self.assertEqual(completed_shifts_page.get_shift_end_time(), '1 p.m.')
