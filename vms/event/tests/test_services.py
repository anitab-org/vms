...
def setUpModule():
    ...
    shift_4 = ["2013-10-23","10:00","18:00",0,j4]
...
class EventOnlyTests(unittest.TestCase):
    ...
    def test_event_not_empty(self):
        ...
        self.assertTrue(event_not_empty(self.e2.id))
        self.assertTrue(event_not_empty(self.e3.id))
    ...
    def test_get_event_by_id(self):
        ...
        # test typical cases
        self.assertIsNotNone(get_event_by_id(self.e1.id))
        self.assertIsNotNone(get_event_by_id(self.e2.id))
        self.assertIsNotNone(get_event_by_id(self.e3.id))

        self.assertEqual(get_event_by_id(self.e1.id), self.e1)
        self.assertEqual(get_event_by_id(self.e2.id), self.e2)
        self.assertEqual(get_event_by_id(self.e3.id), self.e3)

        self.assertIsNone(get_event_by_id(100))
        self.assertIsNone(get_event_by_id(200))
        self.assertIsNone(get_event_by_id(300))

        self.assertNotEqual(get_event_by_id(100), self.e1)
        self.assertNotEqual(get_event_by_id(200), self.e1)
        self.assertNotEqual(get_event_by_id(300), self.e1)

        self.assertNotEqual(get_event_by_id(100), self.e2)
        self.assertNotEqual(get_event_by_id(200), self.e2)
        self.assertNotEqual(get_event_by_id(300), self.e2)

        self.assertNotEqual(get_event_by_id(100), self.e3)
        self.assertNotEqual(get_event_by_id(200), self.e3)
        self.assertNotEqual(get_event_by_id(300), self.e3)
...
class EventWithJobTests(unittest.TestCase):
    ...
    def test_check_edit_event(self):
        ...
        out5 = check_edit_event(self.e5.id, start_date5, stop_date5)
        out6 = check_edit_event(100, start_date6, stop_date6)
        out7 = check_edit_event(self.e4.id, start_date7, stop_date7)
...
class DeleteEventTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.e2 = create_event_with_details(event_2)
        cls.e3 = create_event_with_details(event_3)
    ...
    def test_delete_event(self):
        ...
        self.assertTrue(delete_event(self.e2.id))
        self.assertTrue(delete_event(self.e3.id))
